function Footer(){
    return (
        ...
        <div className="mt-20 text-[9px] md:text-xs py-20 bg-[#F5F5F7] text-gray-500">
            ...
            <li>*Listed pricing is Maximum Retail Price (inclusive of all taxes).</li>
            ...
            <li>**Mac, iPad and Apple Watch trade-in is available only in-store in India. Apple Retail Online in India does not offer trade-in for Mac, iPad and Apple Watch. Trade‑in values will vary based on the condition, year and configuration of your eligible trade‑in device. Not all devices are eligible for credit. You must be at least the age of majority to be eligible to trade in for credit. Trade‑in value may be applied towards a qualifying new device purchase. Actual value awarded is based on receipt of a qualifying device matching the description provided when estimate was made. Sales tax may be assessed on full value of a new device purchase. In-store trade‑in requires presentation of a valid photo ID (local law may require saving this information). Some stores may have additional requirements. Apple or its trade‑in partners reserve the right to refuse, cancel or limit the quantity of any trade‑in transaction for any reason. More details are available from Apple’s trade‑in partner for trade‑in and recycling of eligible devices. Restrictions and limitations may apply.</li>
                ...
                <li>2. Compared with the glass back of previous-generation iPhone.</li>
                <li>3. Compared with previous-generation iPhone.</li>
                <li>4. The display has rounded corners that follow a beautiful curved design, and these corners are within a standard rectangle. When measured as a standard rectangular shape, the screen is 15.93 cm / 6.27″ (iPhone 17, iPhone 17 Pro), 16.63 cm / 6.55″ (iPhone Air) or 17.42 cm / 6.86″ (iPhone 17 Pro Max) diagonally. Actual viewable area is less.</li>
                <li>5. FaceTime calling requires a FaceTime-enabled device for the caller and recipient and a Wi‑Fi connection. Availability over a cellular network depends on carrier policies; data charges may apply.</li>
                <li>6. Enabled by compatible apps.</li>
                <li>Enabled by compatible third-party hardware and software.</li>
                <li>7.All battery claims depend on network configuration and many other factors; actual results will vary. Battery has limited recharge</li>
                <li>8.Genmoji and Image Playground are available in English, French, German, Italian, Japanese, Portuguese (Brazil) and Spanish when Apple Intelligence is enabled on a compatible iPhone.</li>
            </ul>
